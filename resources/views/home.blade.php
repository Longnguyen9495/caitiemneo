...
<html lang="vi">
  <head>
    ...
    <meta name="description" content="Cái Tiệm Neo — tiệm nail tại 47 ngõ 131 Thái Hà, Đống Đa, Hà Nội." />
    ...
    <header class="site-header" data-header>
      <div class="header-inner">
        ...
        <nav id="menu-chinh" class="main-nav" aria-label="Điều hướng chính" data-menu>
          <a href="#gioi-thieu">Về tiệm</a><a href="#cam-hung">Cảm hứng</a><a href="#lien-he">Ghé tiệm</a><a class="nav-cta" href="#dat-lich">Đặt lịch <span aria-hidden="true">↗</span></a>
        </nav>
      </div>
    </header>
    <main id="noi-dung">
      <section id="dau-trang" class="hero section-shell" aria-labelledby="hero-title">
        <div class="hero-copy" data-reveal>
          ...
          <div class="hero-actions"><a class="button button-primary" href="#dat-lich">Đặt lịch online <span aria-hidden="true">↗</span></a><a class="button button-secondary" href="#gioi-thieu">Khám phá tiệm <span aria-hidden="true">↓</span></a></div>
        ...
        <div class="hero-visual" data-reveal data-reveal-delay>
          <div class="hero-art" role="img" aria-label="Minh họa nghệ thuật về đôi tay với những bộ móng có màu sắc ấm áp"><div class="art-disc"></div><div class="art-arch art-arch-one"></div><div class="art-arch art-arch-two"></div><div class="art-hand art-hand-left"><i></i><i></i><i></i><i></i></div><div class="art-hand art-hand-right"><i></i><i></i><i></i><i></i></div><span class="art-word art-word-top">soft<br />ritual</span><span class="art-star art-star-one" aria-hidden="true">✦</span><span class="art-star art-star-two" aria-hidden="true">✦</span></div>
          <p class="visual-caption">Một khoảng dừng<br />cho riêng bạn.</p>
        </div>
      </section>
      <section id="gioi-thieu" class="intro-section section-shell" aria-labelledby="intro-title">
        <div class="section-kicker" data-reveal><p class="eyebrow">Cái Tiệm Neo</p><p class="section-index" aria-hidden="true">01</p></div>
        <div class="intro-content" data-reveal data-reveal-delay><h2 id="intro-title">Một tiệm nail<br />để bạn <em>ghé qua.</em></h2><div class="intro-body"><p class="lead">Ở đây, một cuộc hẹn có thể bắt đầu từ gam màu bạn thích hoặc một điều nho nhỏ bạn muốn thử.</p><p>Để trao đổi trước khi ghé tiệm và nhận thông tin mới nhất, hãy liên hệ Cái Tiệm Neo qua điện thoại hoặc kênh chính thức.</p><div class="inline-links" aria-label="Kênh liên hệ"><a class="arrow-link" href="tel:0826881094">Gọi 0826 881 094 <span aria-hidden="true">↗</span></a><a class="arrow-link" href="https://www.instagram.com/caitiemneo/" target="_blank" rel="noopener noreferrer">Instagram <span aria-hidden="true">↗</span></a></div></div></div>
      </section>
      <section id="cam-hung" class="mood-section" aria-labelledby="mood-title"><div class="section-shell mood-heading" data-reveal><p class="eyebrow">Gợi ý từ tinh thần của tiệm</p><h2 id="mood-title">Màu sắc, đường cong<br />và những <em>chi tiết nhỏ.</em></h2><p>Những khung hình minh họa cho cảm hứng tại Cái Tiệm Neo — không phải ảnh dịch vụ thực tế.</p></div><div class="mood-gallery" aria-label="Các minh họa nghệ thuật về cảm hứng làm móng"><figure class="mood-card mood-earth" data-reveal><div class="mood-hand"><i></i><i></i><i></i><i></i></div><figcaption><span>01</span> earthy details</figcaption></figure><figure class="mood-card mood-cherry" data-reveal data-reveal-delay><div class="mood-nails"><i></i><i></i><i></i></div><figcaption><span>02</span> deep cherry</figcaption></figure><figure class="mood-card mood-line" data-reveal><div class="mood-grid"></div><div class="mood-ribbon"></div><figcaption><span>03</span> tiny rituals</figcaption></figure><figure class="mood-card mood-bloom" data-reveal data-reveal-delay><div class="mood-flower"><i></i><i></i><i></i><i></i><b></b></div><figcaption><span>04</span> soft bloom</figcaption></figure></div></section>
      <section class="story-section section-shell" aria-labelledby="story-title"><div class="story-art" data-reveal aria-hidden="true"><div class="story-stamp"><span>made<br />with<br />care</span></div><span class="story-dot story-dot-one"></span><span class="story-dot story-dot-two"></span></div><div class="story-copy" data-reveal data-reveal-delay><p class="eyebrow">Về Cái Tiệm Neo</p><h2 id="story-title">Neo lại một chút,<br />rồi đi thật <em>đẹp.</em></h2><p>Giữa nhịp phố Thái Hà, Cái Tiệm Neo là một góc nhỏ dành cho những phút bạn muốn ngồi xuống và để đôi tay được chăm chút.</p><p>Mỗi lần ghé tiệm có thể bắt đầu từ một ý tưởng bạn mang theo, hoặc đơn giản là mong muốn dành thời gian cho chính mình.</p><a class="arrow-link" href="https://www.instagram.com/caitiemneo/" target="_blank" rel="noopener noreferrer">Theo dõi @caitiemneo <span aria-hidden="true">↗</span></a></div></section>
      <section id="lien-he" class="visit-section" aria-labelledby="visit-title"><div class="section-shell visit-layout"><div class="visit-copy" data-reveal><p class="eyebrow">Hẹn bạn ở tiệm</p><h2 id="visit-title">Đôi tay của bạn<br />xứng đáng một <em>cuộc hẹn.</em></h2><p>Liên hệ Cái Tiệm Neo để trao đổi trước khi ghé.</p><a class="button button-primary" href="tel:0826881094">Gọi 0826 881 094 <span aria-hidden="true">↗</span></a></div><address class="address-card" data-reveal data-reveal-delay><span class="address-icon" aria-hidden="true">⌖</span><p>47 ngõ 131 Thái Hà<br />Đống Đa, Hà Nội</p><a class="arrow-link" href="https://www.google.com/maps/search/?api=1&query=47%20ng%C3%B5%20131%20Th%C3%A1i%20H%C3%A0%2C%20%C4%90%E1%BB%91ng%20%C4%90a%2C%20H%C3%A0%20N%E1%BB%99i" target="_blank" rel="noopener noreferrer">Mở bản đồ <span aria-hidden="true">↗</span></a></address></div></section>
